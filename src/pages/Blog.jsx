            ...
            <article className="space-y-8">
                <div className="space-y-6">
                    ...
                    <div className="flex items-center overflow-x-auto overflow-y-hidden sm:justify-start flex-nowrap">
                        ...
                        <Link to='author' onClick={() => setTabIndex(1)} className={`flex items-center flex-shrink-0 px-5 py-3 space-x-2 ${tabIndex === 1 ? 'border border-b-0 rounded-t-lg' : 'border-b'}`}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">
                        ...
                        <div onClick={() => handleBookmark(blog)} className="bg-primary p-3 rounded-full bg-opacity-20 hover:bg-opacity-30 cursor-pointer hover:scale-105 duration-100 overflow-hidden">
